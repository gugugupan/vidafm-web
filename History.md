...
==================
  ...
  * 修正了联系我们页面的页脚样式错误。 删除了无效footer模版 删除了无效首页 修正了首页链接（index_v3 -> frontpage) 维持了各种链接。
  * campability for ie
  * minor fix
  * Add video support.
  * Complete #7
  * Complete feature on #6, left some improvements
  * Add databse configuration
  * Complete UI coding for activity show.
  * 1. 添加了评论框，调整了样式。 2. 添加了评论列表，调整了样式。 3. 增加喜欢照片功能。 4. 修正了一些样式的错误。优化了样式表层级关系。
  * 1. activity show的侧边栏。
