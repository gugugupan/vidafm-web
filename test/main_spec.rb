...
describe "api" do
  ...
  describe "function about [account]" do
    it "should let me login with weibo auth" do
      pending
      j = JSON.parse VIDA.call("account/signup_with_vendors", {:from => "weibo", :token => "06e0d3e5062b292e6102470c98435f13", :secret => "defb3121e95b237f694bf935ae8480a6"})
      j['result'].should == 0
  ...
  describe "function about [comment]" do
    ...
    it "should return 'result = 0' when success" do
      j = JSON.parse VIDA.call("comment/list", {:type => "Activity", :type_id => 14938})
      j['result'].should == 0
    end
    ...
    it "should post comment" do
      j = JSON.parse VIDA.call("comment/add", {:type => "Activity", :type_id => 4113, :content => "spec test#{Time.now}"}, {:token => "douban6648871", :secret => "05ctxe"})
      j["result"].should == 0
    end
  end
  ...
  describe "function about like" do
    ...
    it "should like a activity" do
      j = JSON.parse VIDA.call("moment/like", {:activity_id => 4113}, {:token => "douban6648871", :secret => "05ctxe"})
      j["result"].should == 0
    end
  end
  ...
  describe "function about session" do
    ...
    it "should sign up" do
      j = JSON.parse VIDA.call("account/signup_with_vendors", {:from => "weibo", :token => "322a1c29c0c5b2bfe4934177299f09a6", :secret => "cda6c5b7e01ee4f5c8f5b5b3b080ec44"})
      j['result'].should == 0
  ...
  describe "function about user" do
    it "should return the earliest moment the user created" do
      j = JSON.parse VIDA.call("user/show", {:id => 128})
